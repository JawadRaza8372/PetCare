  ...
  return (
    <>
      <HeroTemplate title={`Wings of Resilience`}>
        ...
        />
        <BlogImages
          image1={require("../Utils/wing1.jpg")}
          image2={require("../Utils/wings2.jpg")}
          image3={require("../Utils/wings3.jpg")}
          image1Alt={"Wings of resilience 1"}
          image2Alt={"Wings of resilience 2"}
          image3Alt={"Wings of resilience 3"}
        />
        <AboutUsPara
